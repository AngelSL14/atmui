...
class tipoTarjetaComponent extends Component {
    ...
    componentWillMount() {
        ...
        if (tt === null || tt === undefined) { history("", this.props.history); }
            ...
            this.setState({ capabilities: tt.capabilities, typeScreen: tt.typeScreen, buttonHover: tt.buttonHover });
    ...
    render() {
        return (
            <BB chain={this.state.capabilities} buttonHover={this.state.buttonHover} onMouse={this.handleHoverButtom} action={this.hl} texto={[null, null, null, null, null, "Cuenta de Ahorro", "Cuenta de Crédito", "Cuenta de Cheques"]} component={<h1>Seleccione tipo de tarjeta</h1>} />
        );
    }
}
