...
class indexComponent extends Component{
    ...
    async componentWillMount(){
        ...
        const data = await CapabilitiesPublicity({ip:this.props.ip});
            ...
            if(data.code==="200"){
                    if(data['body']){
                            ...
                            if(data.body[0]['bankStyle']){
                                        ...
                                        this.setState({
                                            publicidad_Extension:data.body[0].extPublicity,
                                            publicidad_Nombre:data.body[0].namePublicity,
                                            serverActive:true,
                                            buttonHover:{
                                                FDK8:sty.style
                                            },
    ...
    async handleImg(){
        const newImg = await CapabilitiesPublicity({ip:this.props.ip});
        if(newImg['code'] !== undefined ){
            if( newImg.code === "200" ){
                ...
                setTimeout(() => {
                    this.setState({
                        publicidad_Extension:newImg.body[0].extPublicity,
                        publicidad_Nombre:newImg.body[0].namePublicity,
        ...
        if(this.state.falloDelServer===true){
            ...
            if(this.state.publicidad_Extension==="swf"){
                return (
                    <div id="index">
                            <div id="up-container">
                                    <ReactSWF 
                                            ...
                                            src={`${urlImg}${this.state.publicidad_Nombre}.${this.state.publicidad_Extension}`}
                    ...
                    return (
                        <div id="index">
                            <div id="up-container" style={{backgroundImage: `url(${urlImg}${this.state.publicidad_Nombre}.${this.state.publicidad_Extension})`,
