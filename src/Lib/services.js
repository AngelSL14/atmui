...
export function AllAtmIso(token) {
    return apiFetch('/atm/findAll', {
        method: 'GET',
        headers: {
...
export function SingleAtmIso(token, id) {
    return apiFetch(`/atm/${id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export function newAllStyles(token) {
    return apiFetch('/misc/bankStyle/findAll', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export function newStyle(token, id) {
    return apiFetch(`/misc/bank/findStyle/${id}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export function allImage(token) {
    return apiFetch('/misc/image/findAll', {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export function singleImage(token, name, category) {
    return apiFetch(`/misc/image/${name}/${category}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': token
...
export function CapabilitiesScreen(data) {
...
export function CapabilitiesPublicity(data) {
